...
Comme vous pouvez le constater, si vous ouvrez le fichier index.html dans votre navigateur, quelle que soit la largeur de votre navigateur, la page n'affiche qu'une image par ligne. Ce format est adapté aux petites résolutions, notamment dans un affichage type portrait. Cette façon de travailler qui consiste à partir de la plus petite résolution possible et en réadaptant le contenu vers des résolutions plus élevées est ce qu'on appelle le mobile first. C'est ce qui est recommandé par Google aujourd'hui.
